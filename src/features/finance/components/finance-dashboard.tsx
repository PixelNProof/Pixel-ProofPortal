...
import { Download, Plus, TrendingUp, DollarSign, CreditCard } from "lucide-react"
import { mockInvoices, mockRevenue } from "../data/mock-finance"
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between space-y-4 md:space-y-0">
        ...
        <div className="flex items-center space-x-2">
          <Button variant="outline" onClick={() => toast("Exporting data...")}><Download className="mr-2 h-4 w-4" /> Export</Button>
          <Button onClick={() => toast("New Invoice modal opened")}><Plus className="mr-2 h-4 w-4" /> New Invoice</Button>
        </div>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-7 mt-4">
        ...
        <Card className="col-span-3">
          <CardHeader>
            ...
            <CardDescription>Status of recent billing.</CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
